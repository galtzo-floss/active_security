# kettle-jem:freeze
# To retain chunks of comments & code during active_security templating:
# Wrap custom sections with freeze markers (e.g., as above and below this comment chunk).
# active_security will then preserve content between those markers across template runs.
# kettle-jem:unfreeze
