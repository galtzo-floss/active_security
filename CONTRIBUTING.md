...
- One spec file per class/module. For each class or module under `lib/`, keep all of its unit tests in a single spec file under `spec/` that mirrors the path and file name exactly: `lib/active_security/my_class.rb` -> `spec/active_security/my_class_spec.rb`.
...
[🧪build]: https://github.com/galtzo-floss/active_security/actions
